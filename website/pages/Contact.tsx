    ...
    <div className="pt-24 pb-16 min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div>
            <div className="space-y-8">
              <div className="flex items-start gap-4">
                <div className="p-3 rounded-lg" style={{ backgroundColor: BRAND.blueLight, color: BRAND.blue }}>
                  <MapPin size={24} />
                </div>
                <div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href={`mailto:${content.contact.email}`} className="text-slate-600 hover:underline" style={{ color: BRAND.blue }}>
              ...
              <div className="flex items-start gap-4">
                <div className="p-3 rounded-lg" style={{ backgroundColor: BRAND.orangeLight, color: BRAND.orange }}>
          ...
          {/* Form */}
          <div className="rounded-3xl p-8 border border-slate-100" style={{ backgroundColor: BRAND.surface }}>
            <h2 className="text-2xl font-bold mb-6 text-slate-900">Send a Message</h2>
            <form className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  <label className="text-sm font-medium text-slate-700">First Name</label>
              <input type="text" className="w-full p-3 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 bg-white" style={{ '--tw-ring-color': BRAND.blue } as React.CSSProperties} />
          </div>
          <div className="space-y-1">
        ...
        <div className="space-y-1">
          ...
          <input type="email" className="w-full p-3 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 bg-white" style={{ '--tw-ring-color': BRAND.blue } as React.CSSProperties} />
        </div>
        <div className="space-y-1">
        ...
        <div className="space-y-1">
          ...
          <textarea rows={5} className="w-full p-3 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 bg-white" style={{ '--tw-ring-color': BRAND.blue } as React.CSSProperties}></textarea>
              </div>
              <button
                type="submit"
        ...
        {/* Payment Info */}
        <div className="mt-20 rounded-3xl p-8 md:p-12 border border-slate-100" style={{ backgroundColor: BRAND.surface }}>
          <h2 className="font-serif text-3xl font-bold text-slate-900 mb-8">Donation & Payment Information</h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h3 className="font-bold mb-4" style={{ color: BRAND.blue }}>Bank Details</h3>
              <p className="text-slate-600 whitespace-pre-line text-sm leading-relaxed font-mono">
                {content.contact.bankDetails}
              </p>
            </div>
            <div>
              <h3 className="font-bold mb-4" style={{ color: BRAND.blue }}>M-Pesa</h3>
