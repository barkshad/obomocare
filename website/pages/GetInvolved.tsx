  ...
  return (
    <div className="flex flex-col sm:flex-row justify-between sm:items-center py-3 border-b border-slate-200 last:border-0 group gap-1">
      ...
      <div className="flex items-center gap-3 justify-between sm:justify-end w-full sm:w-auto">
        ...
        <button
          onClick={handleCopy}
          className="p-1.5 text-slate-400 hover:opacity-80 rounded-md transition-colors"
    ...
    <div className="pt-24 pb-16 min-h-screen" style={{ backgroundColor: '#fff' }}>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8">
          {/* Financial Donation */}
          <div className="bg-white rounded-3xl shadow-md border border-slate-100 p-8 border-l-4" style={{ borderLeftColor: BRAND.orange }}>
            <div className="flex items-start gap-6">
              <div className="p-4 rounded-full hidden sm:block" style={{ backgroundColor: BRAND.orangeLight, color: BRAND.orange }}>
                <CreditCard size={32} />
              </div>
              <div className="flex-grow w-full">
                <h2 className="text-2xl font-serif font-bold text-slate-800 mb-6">Financial Support</h2>
                <div className="grid lg:grid-cols-2 gap-8">
                  <div className="p-6 rounded-xl shadow-inner border border-slate-200 w-full" style={{ backgroundColor: BRAND.surface }}>
                    <h3 className="text-sm font-bold uppercase tracking-wider mb-4 flex items-center gap-2" style={{ color: BRAND.orange }}>
                      Bank Details
                    </h3>
                  ...
                  <div className="space-y-6">
                    <div className="p-6 rounded-xl border border-slate-200">
                      <h3 className="text-sm font-bold uppercase tracking-wider mb-3 flex items-center gap-2" style={{ color: BRAND.orange }}>
                        M-Pesa Donation
                      </h3>
          ...
          {/* Volunteer */}
          <div className="bg-white rounded-3xl shadow-md border border-slate-100 p-8 border-l-4" style={{ borderLeftColor: BRAND.blue }}>
            <div className="flex items-start gap-6">
              <div className="p-4 rounded-full hidden sm:block" style={{ backgroundColor: BRAND.blueLight, color: BRAND.blue }}>
                <UserPlus size={32} />
              </div>
        ...
        <div className="mt-16 text-center">
          <div className="rounded-3xl p-10" style={{ backgroundColor: BRAND.blueLight }}>
