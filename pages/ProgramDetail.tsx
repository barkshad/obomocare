...
export const ProgramDetail: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 pt-20">
      {/* Hero Header */}
      <div className="relative h-[50vh] min-h-[400px] overflow-hidden" style={{ backgroundColor: BRAND_BLUE }}>
        ...
        <div className="absolute inset-0" style={{ background: `linear-gradient(to top, ${BRAND_BLUE}, ${BRAND_BLUE}cc, transparent)` }}></div>
        <div className="absolute bottom-0 left-0 w-full p-8 md:p-12">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-wrap gap-4">
              <span className="px-4 py-2 text-white rounded-full text-sm font-bold flex items-center gap-2 shadow-lg border border-white/20" style={{ backgroundColor: BRAND_ORANGE }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-slate-100">
              <h2 className="font-serif text-2xl font-bold mb-6" style={{ color: BRAND_BLUE }}>About this pillar</h2>
              <div className="prose prose-lg text-slate-600 leading-relaxed whitespace-pre-wrap">
                {program.description}
              </div>

              <div className="mt-10 p-8 rounded-2xl border relative overflow-hidden" style={{ backgroundColor: BRAND_BLUE_LIGHT, borderColor: `${BRAND_BLUE}15` }}>
                <div className="relative z-10">
                  <h3 className="font-bold mb-3 flex items-center gap-2" style={{ color: BRAND_BLUE }}>
              ...
              <div className="bg-white p-8 rounded-3xl shadow-lg border border-slate-100">
                ...
                <div className="space-y-4 pt-6 border-t border-slate-100">
                  <div className="flex items-center gap-3 text-sm text-slate-600">
                    <CheckCircle size={18} style={{ color: BRAND_ORANGE }} className="flex-shrink-0" />
